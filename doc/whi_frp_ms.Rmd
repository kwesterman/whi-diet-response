...
# a <- read_profile("../data/processed/whi_prediction/fat_pct_binary_ldl_whi_white_nominalME.profile")
# plot(x=a$SCORE, y=b$SCORE, xlab="Hard-call-based LDL-FRS score", ylab="Dosage-based LDL-FRS score")
# hist(a$CNT/ 2, xlab="# SNPs non-missing for hard-call-based score", ylab="Count", main="")
...
disease_plots <- lapply(names(outcome_names), function(disease) {
  ...
  plot_summs(fits[[1]], fits[[2]], fits[[3]], fits[[4]],
    ...
    theme(axis.text.y=element_blank(),
          ...
          axis.title.x=element_text(family="", face="plain", color="black", size=8))
})
