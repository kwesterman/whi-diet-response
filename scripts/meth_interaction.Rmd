...
# Load metadata
metadata_whi <- read_table("../int/sfa/whi_phenos.txt")
metadata_fhs <- read_table("../int/sfa/fhs_phenos.txt")
...
ewis_model_whi <- paste0("int_product ~ meth + age + race + bmi + smk_now + smk_py ",
...
```{r ewas-replication, cache=1, eval=F}
