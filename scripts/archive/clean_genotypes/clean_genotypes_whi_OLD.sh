...
cat ../int/metaData_whi.csv | cut -d ',' -f 1 | awk '{print $1,$1}' > ../int/meth_ids.txt 
...
#	gcta64 --dosage-mach-gz ${whi_c2_gecco_cyto}/GECCOchr${i}cyto.dose.c2.gz ../int/plink_imputed/gecco_cyto-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.3 --make-bed --out ../int/plink_imputed/whi_c2_gecco_cyto_chr${i}
#done
#
...
#	gcta64 --dosage-mach-gz ${whi_c2_gecco_init}/GECCOchr${i}init.dose.c2.gz ../int/plink_imputed/gecco_init-info-tmp --keep ../int/whi_sampIDs.txt --imput-rsq 0.3 --make-bed --out ../int/plink_imputed/whi_c2_gecco_init_chr${i}
#done
#
...
#cat ../data/whi/gen/imputedSampleInfo.txt | tail -n +17 | cut -f 1,2 | awk '{print $1,$1,$2,$2}' | sort -u -k 3 > ../int/idUpdate_whi.txt
#plink --bfile ../int/plink_imputed/whi_genos \
#--update-chr $SNPANNO 1 3 \
#--update-map $SNPANNO 2 3 \
#--update-ids ../int/idUpdate_whi.txt \
#--make-bed --out ../int/plink_imputed/updated/whi_genos

awk -F, '$4=="white" {print $1,$1}' ../int/metaData_whi.csv > ../int/whi_white_ids.txt
awk -F, '$4=="black" {print $1,$1}' ../int/metaData_whi.csv > ../int/whi_black_ids.txt
awk -F, '$4=="hispanic" {print $1,$1}' ../int/metaData_whi.csv > ../int/whi_hispanic_ids.txt

plink --bfile ../int/plink_imputed/updated/whi_genos \
	--keep ../int/whi_white_ids.txt \
	--make-bed \
	--out ../int/whi/whi_white_genos

plink --bfile ../int/plink_imputed/updated/whi_genos \
	--keep ../int/whi_black_ids.txt \
	--make-bed \
	--out ../int/whi/whi_black_genos


plink --bfile ../int/plink_imputed/updated/whi_genos \
	--keep ../int/whi_hispanic_ids.txt \
	--make-bed \
	--out ../int/whi/whi_hispanic_genos
