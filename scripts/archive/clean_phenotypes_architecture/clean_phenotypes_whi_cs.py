...
gwas_phenos.to_csv(
    "../data/processed/architecture/whi_all_cs_phenos.txt", sep=" ", na_rep="NA", 
    index=False)
gwas_phenos.query('race == "white"').to_csv(
    "../data/processed/architecture/whi_white_cs_phenos.txt", sep=" ", na_rep="NA", 
    index=False)
gwas_phenos.query('race == "black"').to_csv(
    "../data/processed/architecture/whi_black_cs_phenos.txt", sep=" ", na_rep="NA", 
    index=False)
gwas_phenos.query('race == "hispanic"').to_csv(
    "../data/processed/architecture/whi_hispanic_cs_phenos.txt", sep=" ", na_rep="NA", 
    index=False)
