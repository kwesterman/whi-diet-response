...
final_phenos = delta_dv_rf_combo_names
...
gwas_phenos.to_csv(
    "../data/processed/architecture/whi_all_delta_phenos.txt", sep=" ", na_rep="NA", 
    index=False)
gwas_phenos.query('race == "white"').to_csv(
    "../data/processed/architecture/whi_white_delta_phenos.txt", sep=" ", na_rep="NA", 
    index=False)
gwas_phenos.query('race == "black"').to_csv(
    "../data/processed/architecture/whi_black_delta_phenos.txt", sep=" ", na_rep="NA", 
    index=False)
gwas_phenos.query('race == "hispanic"').to_csv(
    "../data/processed/architecture/whi_hispanic_delta_phenos.txt", sep=" ", na_rep="NA", 
    index=False)
