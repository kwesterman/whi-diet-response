...
diet_vars = ['sfa', 'pufa', 'tot_fat', 'f2c', 'logf2c', 'palm',
             'sfa2pufa', 'n62n3']
risk_factors = ["ldl", "tg", "glu", "hsCRP", "sbp", "bmi"]
...
gwas_phenos.query('race == "white"').to_csv(
    "../data/processed/whi/whi_white_gwas_phenos_statinAdj.txt", sep=" ", na_rep="NA", 
    index=False)
gwas_phenos.query('race == "black"').to_csv(
    "../data/processed/whi/whi_black_gwas_phenos_statinAdj.txt", sep=" ", na_rep="NA", 
    index=False)
gwas_phenos.query('race == "hispanic"').to_csv(
    "../data/processed/whi/whi_hispanic_gwas_phenos_statinAdj.txt", sep=" ", na_rep="NA", 
    index=False)
