...
fam_to_ScADF <- function(bfile) {
  phenos <- read_delim("../data/processed/gen4/mesa_white_gwas_phenos.txt", 
                       delim=" ")
...
run_gwis <- function(outcome, dv, genoset, robust=T) {
    ...
    bfile <- paste0("../data/processed/mesa_white_subsets/mesa_white_", 
...
write_tsv(gwis_res, 
          paste0("../data/processed/gen4/mesa_res/mesa_white_", dv, "_", rf, "_",
                 main_effect_threshold, ".res_raw"))
res_anno <- annotate_sumstats(gwis_res,
                              paste0("../data/processed/mesa_white_subsets/mesa_white_",
